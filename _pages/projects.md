...
[**UNSW Security Society (SecSoc)**](https://unswsecurity.com)\
a community for students interested in cybersecurity. we went to hacker conferences, [started our own](https://scones.secso.cc/), ran [workshops](https://www.youtube.com/watch?v=IFLUcgTjc4E), talks, CTFs, and more!

[**Programming Fundamentals: Revision Videos**](https://www.youtube.com/watch?v=nkkYk6PcPCc&list=PLlRElrOhPo9vgNTfDiVD4mEN26EJZn8jl)\
revision videos on introductory C programming for UNSW's Programming Fundamentals course (COMP1511).
