---
layout: post
title: How Double Degrees Work
date:   2021-02-08
description: An explanation of how double degrees work at Australian universities
---

***This article was written for and first published in [CSESoc's 2021 First Year Guide](https://media.csesoc.org.au/2021-fyg-double-degrees/)***

So, it makes references to a lot of UNSW-specific resources. But if you're from a different university, fear not, the ideas and processes are mostly the same :)
...
Double degrees work by replacing your free electives/gen-ed requirements with your second major (from your second degree). If you don't know what those terms mean or how a course program (usually) works, check out pages 5-7 of [CSESoc's 2021 Pre-Enrolment Guide](https://media.csesoc.org.au/pre-enrolment-guide/).

Here's a visual representation:

<img src="{{ site.baseurl }}/assets/img/double-degrees/double-degrees-tldr.png" width="100%" height="auto">

**To figure out what subjects you have to take:**

Consult the [UNSW Handbook](https://www.handbook.unsw.edu.au/) 💖 
...
If you can't find the one for your particular program, contact [The Nucleus](https://nucleus.unsw.edu.au/en/contact-us) for help! 
...
<img src="{{ site.baseurl }}/assets/img/double-degrees/double-degrees-flexibility.png" width="30%" height="auto">
...
Changing programs is, for the most part, simple admin work. Check out this UNSW article about [Internal Program Transfers](https://student.unsw.edu.au/ipt) to learn more about changing from one program to another, or between single degree and double degree programs.
...
I really enjoyed my courses in 2020, and there's a whole heap of opportunities on offer for whatever one might be interested in - from research, to start-ups, to [societies that teach you how to HACK!? SIGN ME UP!!](https://unswsecurity.com/join/) 
